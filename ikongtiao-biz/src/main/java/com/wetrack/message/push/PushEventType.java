...
public enum PushEventType {
	...
	REJECT_MISSION(2, "拒绝任务", "任务被拒绝", "你的任务已经被拒绝了，请点击查看详情%s%s|你的任务已经被拒绝了，请点击查看详情%s%s","0|1"),
	ASSIGNED_MISSION(3, "分配任务", "任务被分配了", "你的任务被分配给%s维修员请等待维修员与你联系%s|你的任务被分配给%s维修员请等待维修员与你联系%s|%s客户的任务被分配给你了，地址是%s,请及时处理","0|1|2"),
