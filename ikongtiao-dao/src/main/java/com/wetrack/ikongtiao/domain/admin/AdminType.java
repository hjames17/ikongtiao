...
public enum AdminType {
    MANAGER("管理员", new Role[]{Role.VIEW_MISSION,Role.EDIT_MISSION, Role.VIEW_REPAIR_ORDER, Role.EDIT_REPAIR_ORDER,
            ...
            , Role.VIEW_ADMIN_MANAGER, Role.VIEW_SETTINGS, Role.VIEW_FINANCIAL, Role.EDIT_FINANCIAL}),

    SUPERVISOR("检查员", new Role[]{Role.VIEW_MISSION, Role.VIEW_REPAIR_ORDER, Role.VIEW_FIXER,
