package com.wetrack.wechat.deprecated.pay.utils.client;
...
public class TenpayHttpClient {
	...
	public TenpayHttpClient() {
		...
		this.responseCode = 0;
		this.charset = CharsetEnum.GBK.getName();
	...
	protected void callHttps() throws IOException, CertificateException,
		...
		File jksCAFile = new File(caPath + "/" + caJksFile);
		if (!jksCAFile.isFile()) {
			...
			// store jks file
			HttpClientUtil.storeCACert(cert, caJksAlias,
